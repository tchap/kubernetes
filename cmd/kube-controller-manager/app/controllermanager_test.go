...
func TestTaintEvictionControllerGating(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			if err := startControllers(t, ctx, controllerCtx, map[string]*ControllerDescriptor{
...
func TestNoCloudProviderControllerStarted(t *testing.T) {
	...
	var healthChecks mockHealthCheckAdder
	startControllers(t, ctx, controllerCtx, cpControllerDescriptors, &healthChecks)
}
...
func startControllers(
	t *testing.T, ctx context.Context, controllerCtx ControllerContext,
	...
	if err != nil {
		t.Errorf("Failed to build controllers: %v", err)
		return err
	}

	if err := StartControllers(ctx, controllerCtx, controllers); err != nil {
