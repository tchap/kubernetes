...
func newValidatingAdmissionPolicyStatusControllerDescriptor() *controller.ControllerDescriptor {
...
func newValidatingAdmissionPolicyStatusController(ctx context.Context, controllerContext ControllerContext, controllerName string) (controller.Controller, error) {
