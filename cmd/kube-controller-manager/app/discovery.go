...
func newEndpointSliceControllerDescriptor() *controller.ControllerDescriptor {
...
func newEndpointSliceController(ctx context.Context, controllerContext ControllerContext, controllerName string) (controller.Controller, error) {
...
func newEndpointSliceMirroringControllerDescriptor() *controller.ControllerDescriptor {
	return &controller.ControllerDescriptor{
...
func newEndpointSliceMirroringController(ctx context.Context, controllerContext ControllerContext, controllerName string) (controller.Controller, error) {
